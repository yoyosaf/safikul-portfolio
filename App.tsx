      ...
      return (
        <div className="min-h-screen bg-[#000] flex items-center justify-center px-6">
          <form onSubmit={handleLogin} className="max-w-md w-full bg-white/[0.02] border border-white/5 p-12 rounded-sm space-y-6">
            <h2 className="text-2xl font-black uppercase tracking-tighter text-center">Admin Key</h2>
            <div className="space-y-4">
              ...
              <input id="admin_pass" type="password" className="w-full bg-white/5 border border-white/10 rounded-sm px-4 py-4 text-white outline-none" placeholder="Pass" />
            </div>
            <button type="submit" className="w-full py-4 bg-blue-600 text-white font-black uppercase tracking-widest text-[10px]">Verify</button>
            <a href="/" className="block text-center text-white/20 text-[10px] uppercase tracking-widest mt-4">Exit</a>
          </form>
        </div>
      );
    }
